"""
Configuration file for Model_2 — a flexible Convolutional Neural Network (CNN)
...
MODEL_CONFIG = {
    ...
    # -------------------------------------------------------------------------
    # Initial 2-branch parallel convolutions (outputs are concatenated)
    ...
    # 1st value (64) must equal conv01_out * 2
    "channels": [64, 64, 128, 256, 512, 1024, 2048, 4096, 8192],
